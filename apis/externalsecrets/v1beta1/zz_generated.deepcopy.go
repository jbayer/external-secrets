...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DeleteSecretError) DeepCopyInto(out *DeleteSecretError) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeleteSecretError.
func (in *DeleteSecretError) DeepCopy() *DeleteSecretError {
	if in == nil {
		return nil
	}
	out := new(DeleteSecretError)
	in.DeepCopyInto(out)
	return out
}
